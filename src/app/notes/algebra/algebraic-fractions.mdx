...
| Maths                                 | Explanation                                                                                                                  |
| :------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------- |
| Simplify $$\frac{3x^2 + 9x}{x^2 -9}$$ | The numerator is easily factorised into $3x(x+3)$. The denominator is factorised using difference of squares                 |
...
| Maths                                                                        | Explanation                                                                                                                                                                                                                                                                                         |
| :--------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Simplify fully $$ \frac{2x-2}{x+5} \div \frac{x^2 -4x +3}{2x^2 + 13x + 15}$$ | The first thing to do is the same as with any division fraction<br>question: KFC (Keep Flip Change)                                                                                                                                                                                                 |
