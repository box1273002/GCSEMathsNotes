export const subjects = [
  ...
  {name: 'Polygons and Geometry', id: 'polygons_and_geometry',topics: [
    ...
    {name:"Properties of key quadrilaterals", description: "Lengths, diagonals and angles; when they are the same, bisect and add up to 180°", higher:  false},
    ...
    {name:"Constructions", description: "Using a compass and ruler to construct 30°, 45°, 60° and perpendiculars, and to bisect angles", higher:  false},
