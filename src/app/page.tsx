...
export default function Home() {
  return (
    <main className={`${shadowsIntoLight.className} pb-14 flex flex-col justify-center items-center h-screen bg-[url('/blackboard.jpg')] bg-cover`}>
      ...
      <Link href='/subjects/algebra' className=' flex-auto text-3xl w-16 mx-16 text-center hover:underline hover:font-bold'>Notes</Link> 
      <Link href='/subjects/trigonometry' className='flex-auto text-3xl w-16 mx-16 text-center hover:underline hover:font-bold'>Questions</Link>
      </div>
    </main>
  );
}
