...
export default function Home() {
  ...
  return (
    <main className={`${shadowsIntoLight.className} flex flex-col justify-center items-center h-screen w-screen bg-[url('/web_images/blackboard.jpg')] bg-cover absolute top-0 z-0`}>
